function S = simulate_ExtNIG(S0, T, r, N_SIM, N, PARAMS)

% Simulate Extended Normal Inverse Gaussian prices with Monte Carlo technique starting from Inverse Gaussian subordinators
% S(t) = S0 * exp( rt + X(t) )
% X(t) is a Extended Normal Inverse Gaussian process in the Risk Neutral measure
