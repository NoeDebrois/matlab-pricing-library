...
% Price a Knock and Out Put Option with PIDE method
...
D  = 0.7 * S0; % lower barrier
U  = 1.3 * S0; % upper barrier
...
for j = M:-1:1 % known t_j --> unknown t_{j-1}
    ...
    % Remark: BC is always zero for a Knock & Out option
