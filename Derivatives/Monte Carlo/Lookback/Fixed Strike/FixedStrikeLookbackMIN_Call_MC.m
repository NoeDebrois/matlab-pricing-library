...
% Option considered: Fixed Strike Lookback Call on Minimum
% Payoff: { m(T) - K }⁺ where m(T) = min_t ∈ [0, T] ( S(t) )
% Note: S0 must be bigger than K to have a non zero price of the option
